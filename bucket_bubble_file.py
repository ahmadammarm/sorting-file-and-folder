...
def sort_files_by_size(folder_path):
    ...
    # Mengurutkan file menggunakan bubble sort setelah pengurutan bucket
...
if __name__ == "__main__":
    ...
    sorted_output_file_path = "sorted_files_bucket_bubble.txt"
    ...
    buckets_output_file_path = "buckets_details_bubble.txt"
